...
namespace game_ideas
{
    public class EnemyAssetDestroy : MonoBehaviour
    {
        ...
        {
            GameObject newObj = Instantiate(objectDestroy, goingDestroy.transform.position, goingDestroy.transform.rotation, goingDestroy.transform.parent) as GameObject;
